          ...
          >
            <div class="px-4 w-full md:w-8/12 xl:w-6/12">
              ...
              <p class="font-thin mb-6 text-gray-300">
                Find your perfect plant today! From potho to monsteras to everything in between, your ought to find 
                your perfect plant here!
              </p>
              <BaseButton
                size="xl"
                label="Visit today"
              ...
              >
                <div class="inline-block ml-1 p-1.5 text-lg">Visit today</div>
                <BaseIcon height="28px"></BaseIcon>
              </BaseButton>
            </div>
          </div>
        </div>
